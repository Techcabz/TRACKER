...
<template>
  <li>
    <router-link
      :to="item.to"
      class="group relative flex items-center text-graydark gap-2.5 rounded-sm py-2 px-4 font-medium duration-300 ease-in-out hover:text-graydark dark:hover:text-meta-4"
      @click.prevent="handleItemClick"
      :class="{ 'bg-dark dark:bg-meta-4': sidebarStore.page === item.label }"
    >
