...
<template>
  <header
    class="sticky top-0 z-999 flex w-full bg-black drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none"
  >
    <div
        ...
        <form method="POST">
          <div class="relative">
            <button class="absolute top-1/2 left-0 -translate-y-1/2">
              <svg
                class="fill-body hover:fill-white dark:fill-bodydark dark:hover:fill-white"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
